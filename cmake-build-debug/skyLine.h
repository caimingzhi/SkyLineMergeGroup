...
#include <queue>
#include <iostream>
#ifndef SKYLINE_SKYLINE_H
#define SKYLINE_SKYLINE_H
using namespace std;
class Item
{
private:
...
//        cout << skyLine.getLen() << " " << skyLine.getY() << " " << skyLine.getX() << endl;
        ...
        skyLinQueueCopy.sort( CompareSkyLine() );
...
//                    cout << " /////////////////// " <<  endl;
//                    cout << iter -> getX() << " " << iter -> getY() << " " << skyLine.getLen() + iter ->getLen() << endl;
